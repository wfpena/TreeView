...
{
    [DependsOn(
        typeof(TreeViewDataModule), 
        typeof(TreeViewWebApiModule),
        typeof(AbpWebMvcModule))]
    public class TreeViewWebModule : AbpModule
    {
            ...
            Configuration.Localization.Sources.Add(
                new DictionaryBasedLocalizationSource(
                    ...
                    new XmlFileLocalizationDictionaryProvider(
                        HttpContext.Current.Server.MapPath("~/Localization/TreeView")
                        )
                    )
                );

            //Configure navigation/menu
            Configuration.Navigation.Providers.Add<TreeViewNavigationProvider>();
        }
